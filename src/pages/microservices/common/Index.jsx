...
function IndexContent({ onLogout, user }) {
      ...
      try {
        ...
        if (!contentType || !contentType.includes('application/json')) {
          ...
          if (usuariosRes.status === 401) {
            ...
            console.error('La ruta no existe. Verifica que el backend esté funcionando.');
            return;
          } else {
            console.error(`El servidor devolvió una respuesta inválida (${usuariosRes.status})`);
            return;
          }
        }
  ...
  return (
    <>
          ...
          <div className="sidebar-wrapper scrollbar scrollbar-inner">
            <div className="sidebar-content">
              ...
              <div className="px-3">
                ...
                >
                  <div
                    ...
                    aria-label="avatar"
                  >
                    <i className="fas fa-user" style={{ fontSize: '22px', color: '#fff' }}></i>
                  </div>
                  <div className="mt-2 text-center" style={{ maxWidth: '220px' }}>
                    <div className="text-white-50" style={{ fontSize: '12px' }}>Hola,</div>
                    <div
              ...
              <div className="mt-3 px-3">
                <Link to="/configuracion" className="btn btn-outline-light w-100">
            ...
            <Routes>
              ...
              {user.rol === 'Administrador' && (
                <>
                  ...
                  <Route path="/reportes-inscripcion" element={<ReporteInscripcion />} />
                </>
              )}
              ...
              {user.rol === 'Cajero' && (
                <>
                  ...
                  <Route path="/adquisicion-servicios" element={<AdquisicionServicios />} />
                </>
              )}
              ...
              {user.rol === 'Administrador' && (
                <>
                  ...
                  <Route path="/historial-chat" element={<HistorialChatWhatsApp />} />
                  <Route path="/documentos-agente" element={<DocumentosAgente />} />
      ...
      {(user.rol === 'Administrador' || user.rol === 'Director' || user.rol === 'Secretaria') && (
        <AgenteInteligenteFloating user={user} />
      )}
